window.addEventListener('load', function () {
    ...
    let in_count = document.getElementById('id_in_count');
    let out_count = document.getElementById('id_out_count');
