    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('valute_from', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cash_valutes_from', to='general_models.valute', verbose_name='Отдаём')),
                ('valute_to', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cash_valutes_to', to='general_models.valute', verbose_name='Получаем')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('guest', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='cash_reviews', to='general_models.guest', verbose_name='Гостевой пользователь')),
            ],
            options={
                'verbose_name': 'Отзыв',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('moderation', models.BooleanField(default=False, verbose_name='Прошел модерацию?')),
                ('grade', models.CharField(choices=[('1', 'Положительный'), ('0', 'Нейтральный'), ('-1', 'Отрицательный')], default='0', verbose_name='Оценка')),
                ('guest', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='cash_comments', to='general_models.guest', verbose_name='Гостевой пользователь')),
        ...
        migrations.AddIndex(
            model_name='exchange',
            index=models.Index(fields=['is_active'], name='cash_exchan_is_acti_03bc40_idx'),
        ),
        migrations.AddIndex(
